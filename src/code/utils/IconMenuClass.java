...
public class IconMenuClass implements Listener {
	...
	public IconMenuClass(String name, int size, OptionClickEventHandler handler,
			Plugin plugin) {
		this.name = name;
		this.size = size;
	...
	public IconMenuClass setOption(int position, ItemStack icon, String name,
	...
	public IconMenuClass setOption(int position, ItemStack icon, String reg) {
		optionRegs[position] = reg;
		optionNames[position] = name;
	...
	public class OptionClickEvent {
		...
		private IconMenuClass im;

		private boolean rightClick, leftClick, Shift;

		public OptionClickEvent(Player player, int position, String name,
				IconMenuClass im, boolean rightClick, boolean leftClick,
				boolean Shift) {
			this.player = player;
		...
		public IconMenuClass getIconMenu() {
			return this.im;
		}
